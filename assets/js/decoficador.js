...
function encriptar(elemento) {
    ...
    console.log("Valor de codigoBase64", codigoBase64);
    console.log("Valor de codigoMorse", codigoMorse);
    console.log("Valor de cifradoCesar", cifradoCesar);
